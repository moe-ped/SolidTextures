Shader "Custom/Generated/Example" 
{
	Properties 
	{
	...
	SubShader 
	{
		...
		Pass 
		{
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				/*Generated*/c=lerp(float4(0.875,0.711714,0.3602941,0.3602941),float4(0.3088235,0.2877759,0.199827,0.199827),lerp(saw((50*length(float2(((perlin3d(20*x,20*y,5*z)*0.03)+y),((perlin3d(20*x,20*y,5*z)*0.03)+x))))),saw(((50*length(float2(((perlin3d(20*x,20*y,5*z)*0.03)+y),((perlin3d(20*x,20*y,5*z)*0.03)+x))))*5)),0.1));/*EndGenerated*/

...
public class MaterialNodeEditor : EditorWindow
{
	...
	void OnGUI()
	{
		...
		{
			Vector2 mousePos = evt.mousePosition+scrollPosition-Vector2.up*40;
			...
			menu.AddItem (new GUIContent ("New Function/Sine"), false, () => {Nodes.Add(new SineNode(mousePos));});
			menu.AddItem (new GUIContent ("New Function/Cosine"), false, () => {Nodes.Add(new CosineNode(mousePos));});
			menu.AddItem (new GUIContent ("New Function/Power"), false, () => {Nodes.Add(new PowerNode(mousePos));});
			menu.AddItem (new GUIContent ("New Function/Clamp"), false, () => {Nodes.Add(new ClampNode(mousePos));});
